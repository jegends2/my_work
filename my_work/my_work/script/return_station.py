...
class ReturnStation(Node):
    ...
    def __init__(self):
        ...
        self.station_center_x = -2.0  # Define the station center x
        self.station_center_y = 2.0  # Define the station center y
    ...
    def timer_callback(self):
        ...
        if self.current_pose:
            self.get_logger().info(f'Current pose: ({self.current_pose.transform.translation.x}, {self.current_pose.transform.translation.y})')
    ...
    def get_current_pose(self):
        try:
            ...
            self.current_pose = transform  # 이제 self.current_pose는 TransformStamped 타입입니다.
